...
`git clone https://github.com/rohitfarmer/DeepLearningCyTOF.git`

## Pull the Singularity Container and Execute the Jupyter Notebook on Locus (HPC)
**Pull the latest Singularity container in your cloned/working directory using the link below.**  
...
1. Keep the SSH session and Jupyter notebook session running.
